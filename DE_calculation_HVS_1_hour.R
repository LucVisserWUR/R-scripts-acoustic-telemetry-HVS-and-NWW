title: "1 hourly detection efficiency calculations for the HVS study area"
Author: "Luc Visser"
date: "2024-21-04"

# Clean workspace & load required packages
...
# Bin observed observations per hour, then join with expected values
...
# Merge observed with expected detections
...
# Clean working environment except for the relevant hourly detection efficiency datasets
