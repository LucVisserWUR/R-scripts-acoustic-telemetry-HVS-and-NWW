...
# Create an hour key for the study period
...
#one_hourly_observed_expected_detections_NWW <- one_hourly_observed_expected_detections_NWW %>%  <- Worked initially but not anymore. Leave out for now but might use it later
  #mutate(obs = 1:n()) %>% 
