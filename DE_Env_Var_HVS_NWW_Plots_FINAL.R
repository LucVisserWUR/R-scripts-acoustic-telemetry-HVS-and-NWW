...
# Chapters 
# 1. PREPARE THE DATA AND PREPARE A COMPLETE DE & ENV.VARIABLE DATASET
# 2. EXPLORE THE RELATIONS BETWEEN ENV. VARIABLES AND DE FOR EACH STUDY AREA
...
# First introduce a column for month for both the HVS and NWW dataset. 
# HVS
...
# --> Statistically analyse the 'Env_DE_HVS_NWW_total' dataset in the 'HVS_NWW_multinom_models_analysis_FINAL.R script'
...
# Statistics of sluice management type HVS river
...
# Average detection efficiency over different sluice opening bins for each sluice management type
...
# Average DE over different windspeed bins for each wind direction 
